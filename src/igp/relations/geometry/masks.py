...
Usage:
    >>> import numpy as np
    >>> from igp.relations.geometry.masks import mask_iou, depth_stats_from_map
    ...
    >>> from igp.relations.geometry.masks import _mask_contact_along_y
...
Dependencies:
    ...
    - igp.relations.geometry.core: as_xyxy for box extraction
...
See Also:
    - igp.relations.geometry.predicates: High-level spatial predicates
    - igp.relations.geometry.core: Box-based geometric operations
    - igp.segmentation: Mask generation (SAM/SAM2/FastSAM)
    - igp.utils.depth: Depth map estimation
"""
