...
Usage:
    >>> from igp.relations.geometry import iou, center_distance, is_on_top_of
    >>> 
    >>> # Basic IoU
    ...
    >>> from igp.relations.geometry import centers_vectorized, pairwise_distances_vectorized
...
See Also:
    - igp.utils.boxes: Additional box utilities
    - igp.relations.inference: Relationship extraction pipeline
"""
