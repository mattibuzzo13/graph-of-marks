...
See Also:
    ...
    - igp.detectors.yolov8: Faster closed-vocabulary alternative
...
class OwlViTDetector(Detector):
    ...
    See Also:
        - igp.detectors.yolov8: Faster closed-vocabulary detector
        - igp.detectors.grounding_dino: Alternative open-vocabulary model
    """
