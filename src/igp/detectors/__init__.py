...
Usage:
    >>> from igp.detectors import YOLOv8Detector, OwlViTDetector
    >>> 
    >>> # Real-time detection
...
See Also:
    - igp.detectors.base: Detector abstract interface
    - igp.detectors.manager: Multi-detector orchestration
    - igp.fusion: Detection fusion strategies
"""
