...
Usage:
    >>> from igp.segmentation import SAM1Segmenter, SegmenterConfig
    >>> 
...
See Also:
    - igp.segmentation.sam1: SAM v1 implementation
    - igp.segmentation.sam2: SAM v2 implementation
    - igp.segmentation.refinement: Advanced post-processing
    - igp.types.MaskDict: Mask dictionary type definition
"""
